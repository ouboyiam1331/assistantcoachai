      ...
      <div className="mx-auto w-full max-w-4xl">
        ...
        <section className="tgem-surface rounded-3xl px-8 py-10">
          ...
          <section className="mt-10 space-y-6 text-sm leading-7 text-gray-700 dark:text-gray-300">
            ...
            <div className="space-y-2">
              <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">How We Use Information</h2>
              <p>
            ...
            <div className="space-y-2">
              <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Cookies and Similar Technologies</h2>
              <p>
            ...
            <div className="space-y-2">
              <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Your Choices</h2>
              <p>
            ...
            <div className="space-y-2">
              <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Children&apos;s Privacy</h2>
              <p>
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                <a className="underline hover:text-gray-700 dark:hover:text-gray-300" href="mailto:contact@tgemsports.com">
